...
describe "beerlist page" do
  ...
  it "shows beers in the right order after having ordered by style", js:true do
    visit beerlist_path
    click_link('Style')
  ...
  it "shows beers in the right order after having ordered by brewery", js:true do
    visit beerlist_path
    click_link('Brewery')
